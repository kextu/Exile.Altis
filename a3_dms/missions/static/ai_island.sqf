...
_AIMaxReinforcements = (15 + (round (random 5)));		//AI reinforcement cap
_AItrigger = (5 + (round (random 5)));					//If AI numbers fall below this number then reinforce if any left from AIMax
...
_AIMaxReinforcements = (20 + (round (random 7)));
_AItrigger = (5 + (round (random 10)));
...
_AICount = (22 + (round (random 7)));
_AIMaxReinforcements = (20 + (round (random 8)));
...
_AICount = (22 + (round (random 10)));
_AIMaxReinforcements = (25 + (round (random 10)));
...
_msgStart = ['#FFFF00',format["A large group of %1 Bandits have invaded the island and are drinking beer and eating cake",_difficultyM]];

// Define Mission Win message
_msgWIN = ['#0080ff',"Convicts have successfully killed the Bandits and claimed all the cake and beer for themselves!"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The Bandits have finished their beer and cake and buggered off..."];
