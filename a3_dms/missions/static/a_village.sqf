...
_msgStart = ['#FFFF00', "Bandits are raiding the abandoned village for cake and beer"];

// Define Mission Win message
_msgWIN = ['#0080ff',"Convicts have successfully killed the Bandits and stolen all the cake"];
