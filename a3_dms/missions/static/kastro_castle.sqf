...
[
	[
		...
		[
			...
			[
				30,	// Maximum 100 units can be given as reinforcements.
				0
			]
		],
		[
...
_msgStart = ['#FFFF00', "Bandits have invaded the castle gift shop"];

// Define Mission Win message
_msgWIN = ['#0080ff',"Convicts have successfully killed the Bandits and stolen all the crates"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"Bandits got bored and buggered off taking all the goodies..."];
