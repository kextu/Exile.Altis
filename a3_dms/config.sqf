...
/* Mission System Settings */
	...
	DMS_MaxStaticMissions				= 4;						// Maximum number of Static Missions running at the same time. It's recommended you set this to the same amount of static missions that you have in total.
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_assault_bipod_chance			= 55;						// Percentage chance that an Assault Class AI will get a bipod
