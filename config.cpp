...
{	ExileClient_object_player_event_onEnterSafezone = "overwrites\exile_client\ExileClient_object_player_event_onEnterSafezone.sqf"; //R3F Dettach Safezonefix
	...
	ExileClient_system_trading_network_purchaseVehicleResponse = "overwrites\exile_client\ExileClient_system_trading_network_purchaseVehicleResponse.sqf";
	ExileClient_util_playerEquipment_add = "overwrites\exile_client\ExileClient_util_playerEquipment_add.sqf";  // Rocket launcher fix 
	/*
...
class CfgXM8
{
	extraApps[] = {"ExAd_VG","ExAd_Info","ExAd_CHVD","ExAd_Journal","ExAd_Bike","ExAd_Quad","BRAmaRecipes"};
...
class CfgTerritories
{
	...
	prices[] = 
	{
		...
		{5000,					45,			90 					}, // Level 1
		{10000,					60,			120 				}, // Level 2 
		{15000,					75,			150 				}, // Level 3
		{20000,					90,			180					}, // Level 4
		{25000,					105,		210					}, // Level 5
		{40000,					120,		350					}, // Level 6
		{50000,					135,		450					}, // Level 7
		{60000,					150,		550					}, // Level 8
		{75000,					165,		650					}, // Level 9
		{100000,				180,		750					}  // Level 10
	};
