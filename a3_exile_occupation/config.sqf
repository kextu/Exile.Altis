...
SC_maxAIcount					= 85;						// the maximum amount of AI, if the AI count is above this then additional AI won't spawn
...
SC_minDistanceToTerritory   	= 600;                  	// Minimum distance in metres to the nearest player territory
...
SC_fastNightsMultiplierDay  	= 2;                    	// the time multiplier to use during daylight hours (4 = 4x speed)
...
SC_numberofHeliCrashes      	= 6;                    // if SC_occupyHeliCrashes = true spawn this many loot crates
...
SC_SurvivorHeadgear         	= []; 
SC_SurvivorWeapon           	= [			"rhs_weap_m16a4",
											"rhs_weap_m4",
											"rhs_weap_m4a1",
											"rhs_weap_mk18",
											"rhs_weap_ak103",
...
SC_BanditWeapon             	= ["LMG_Zafir_F","arifle_Katiba_C_F","arifle_Katiba_F","arifle_Katiba_GL_F","arifle_MXC_Black_F","arifle_MXC_F","arifle_TRG20_F","arifle_TRG21_F","arifle_TRG21_GL_F",											"rhs_weap_m16a4",
											"rhs_weap_m4",
											"rhs_weap_m4a1",
											"rhs_weap_mk18",
											"rhs_weap_ak103",
											...
											"LMG_mas_pkm_F",
											"LMG_mas_pech_F"];
SC_BanditWeaponAttachments  	= [			"optic_ERCO_khk_F",
											"optic_DMS_ghex_F",
											"optic_Arco_blk_F",
											"optic_Hamr",
											"optic_Aco",
...
if(SC_useApexClasses) then 
{
	SC_BanditWeapon 			= [	"arifle_MX_khk_F","arifle_MX_GL_khk_F","arifle_MX_SW_khk_F","arifle_MXC_khk_F","arifle_MXM_khk_F","arifle_AK12_F","arifle_AK12_GL_F","arifle_AKM_F",
                                    ...
                                    "arifle_SPAR_03_blk_F","arifle_SPAR_03_khk_F","arifle_SPAR_03_snd_F","rhs_weap_m4",
											"rhs_weap_m4a1",
											"rhs_weap_mk18",
											"rhs_weap_ak103",
											"rhs_weap_akm",
